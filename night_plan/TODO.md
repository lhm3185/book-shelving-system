...
## 마무리 (06:15 이후 또는 위가 끝나면)
- [ ] F-1 모든 새 스위치 끈 전체 한 바퀴 1회 (회귀 — 0-2 와 같은 결과여야 함)
- [ ] F-2 NIGHTLY_20260923.md 아침 보고서 + night/handoff/SUMMARY.md
- [ ] F-3 시행착오 문서: 오늘 밤 항목을 우선순위 순서(블록 2 → 3 → 1 → 4 → 5 → 6)로, 한 항목 한 페이지 (night/handoff/trial_and_error_0922.md, 형식은 NIGHTLY_PLAN 마무리 절)
- [ ] F-4 night/handoff/ 정리(영상·사진·media_index.md·LEDGER 사본) → 회귀 통과 시 feature/robot_control push → touch night/DONE
