...
실행
    ISAAC_ENTRY=isaac_sim/isaac/tools/verify_carter_m0609.py ./scripts/run_isaac_tool.sh
"""
import argparse
import os
import sys
...
ap.add_argument("--usd", default=str(_REPO_ROOT / "isaac_sim/assets/ing_library_env_v5-test.usd"))
