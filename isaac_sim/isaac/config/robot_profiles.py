...
# 이 파일은 <저장소>/isaac_sim/isaac/config/ 에 있다 → 세 단계 올라가면 저장소 루트
...
M0609 = RobotProfile(
    ...
    lula=("files", _first_existing(
              os.path.join(_REPO, "isaac_sim/assets/m0609/descriptor/m0609_description.yaml"),
              os.path.expanduser("~/Isaac_Sim_b-1/src_pra/M0609/descriptor/m0609_description.yaml")),
          _first_existing(
              os.path.join(_REPO, "isaac_sim/assets/m0609/urdf/m0609.urdf"),
