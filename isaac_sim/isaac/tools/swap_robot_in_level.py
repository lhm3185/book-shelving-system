...
실행
    ISAAC_ENTRY=isaac_sim/isaac/tools/swap_robot_in_level.py ./scripts/run_isaac_tool.sh \\
    ...
    ARM_ROBOT=m0609 SIM_USD=~/Desktop/ing_library_env_m0609.usd \\
        ISAAC_ENTRY=isaac_sim/isaac/tools/check_reach.py ./scripts/run_isaac_tool.sh
"""
import argparse
import os
import sys

# tools/ → isaac/ → isaac_sim/ → 저장소 루트 (네 번 올라간다)
...
say("    ISAAC_ENTRY=isaac_sim/isaac/tools/check_reach.py ./scripts/run_isaac_tool.sh")
